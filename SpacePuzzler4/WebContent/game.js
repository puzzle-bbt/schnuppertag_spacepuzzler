...
window
		.addEventListener(
				...
				function() {
					...
					Q.Sprite.extend("Player", {
						...
						init : function(p) {
							this._super(p, {
								...
								sprite : "player",
								direction : "right",
								standingPoints : [ [ -16, 44 ], [ -23, 35 ], [ -23, -48 ], [ 23, -48 ], [ 23, 35 ],
										[ 16, 44 ] ],
								duckingPoints : [ [ -16, 44 ], [ -23, 35 ], [ -23, -10 ], [ 23, -10 ], [ 23, 35 ],
										[ 16, 44 ] ],
								jumpSpeed : -400,
								speed : 300,
								strength : 100,
							...
							Q.input.on("right", this, "checkDoor"); // TODO: Fehler: Q.input.on("down", this,
																	// "checkDoor");
						},
						...
						jump : function(obj) {
							...
							if (!obj.p.playedJump) {
								...
								// TODO: Fehler: Q.audio.play('jump.mp3');
							}
						},
					...
					Q
							.loadTMX(
									"level1.tmx, collectables.json, doors.json, enemies.json, fire.mp3, jump.mp3, heart.mp3, hit.mp3, coin.mp3, player.json",
									function() {
